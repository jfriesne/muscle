...
#ifdef WIN32
   /** For Windows only:  Given the name of a module and a Relative Virtual Address, this
    *  function will return the name of the debugging-symbol corresponding to that address
    *  if possible, or a human-readable error string otherwise.  This can be useful when remotely
    *  analyzing stack traces that were generated by machines that did not have the necessary PDB files
    *  present when they generated their stack-trace output text.
    *  @param optModuleName optional name of the module that (rva) is relative to.  If NULL, the
    *                       default module (corresponding to the executable itself) will be assumed.
    *  @param rva the Relative Value Address (i.e. a byte-offset from the specified module's base
    *             address), e.g. as printed out by the StackWalker error-reporting code as part of
    *             a PDB-less stack trace.
    */
