...
MUSCLE_NODISCARD static inline int32 sendto_ignore_eintr(  int s, const void *b, uint32 numBytes, int flags, const struct sockaddr * d, muscle_socklen_t dlen) {int32 ret; do {ret = (int32)sendto(s, (char *)b, numBytes, flags,  d, dlen);} while((ret<0)&&(PreviousOperationWasInterrupted())); return ret;}
#ifndef WIN32
