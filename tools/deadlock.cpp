...
public:
   ...
   virtual void InternalThreadEntry()
   {
      ...
      {
         (void) Snooze64(MillisToMicros(GetInsecurePseudoRandomNumber32(200))); // space things out in time, otherwise we get deadlocks so often that it's hard to run the program to completion
