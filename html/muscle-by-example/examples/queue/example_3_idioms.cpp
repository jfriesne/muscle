...
{
   p.printf("\n");
   p.printf("This program demonstrates various minor convenience methods of the Queue class\n");
   p.printf("\n");
}
...
#ifdef MUSCLE_AVOID_CPLUSPLUS11
   for (ConstQueueIterator<String> qIter = q.GetIterator(); qIter.HasData(); qIter++)
#else
