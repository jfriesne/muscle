...
* You can optionally specify an array of human-readable names for the bits in the BitChord, to make the output of [BitChord::ToString()](https://public.msli.com/lcs/muscle/html/classmuscle_1_1BitChord.html#a77dc8809a30dd691a9c24c940e644f7e) more user-friendly, e.g. `DECLARE_LABELLED_BITCHORD_FLAGS_TYPE(FruitBits, NUM_FRUITS, _fruitBitsLabels);`
* Methods and constructors using variadic arguments work under both C++11 or later (using variadic templates) and C++03 (using a fallback macro-based implementation)
