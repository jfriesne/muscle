...
* By default, any data passed to [StdinDataIO::Write()](https://public.msli.com/lcs/muscle/html/classmuscle_1_1StdinDataIO.html#a0672add49f6c0f410c361f66a9b00ced) is simply discarded, since writing to `stdin` doesn't really make sense.  However, if you pass `true` to the [StdinDataIO](https://public.msli.com/lcs/muscle/html/classmuscle_1_1StdinDataIO.html) constructor's second argument, then any data passed to [StdinDataIO::Write()](https://public.msli.com/lcs/muscle/html/classmuscle_1_1StdinDataIO.html#a0672add49f6c0f410c361f66a9b00ced) will be printed to `stdout` instead.
