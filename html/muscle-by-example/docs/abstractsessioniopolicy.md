...
* The most commonly used I/O policy is the [RateLimitSessionIOPolicy](https://public.msli.com/lcs/muscle/html/classmuscle_1_1RateLimitSessionIOPolicy.html), which allows you to limit the amount of network bandwidth used by the server.
