...
#define PR_NAME_REMOVE_FROM_INDEX          "!Rmv"       /**< If specified as a Message-field-name in PR_COMMAND_REORDERDATA, the affected nodes will be removed from their parent's ordered-node-index */
