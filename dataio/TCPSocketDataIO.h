...
/** The default number of microseconds that MUSCLE should allow a TCP connection to remain in a "stalled" state for, before giving up and closing it.  Defaults to three minutes, but the default may be overridden at compile-time via eg -DMUSCLE_DEFAULT_TCP_STALL_TIMEOUT=MinutesToMicros(5) or similar. */
