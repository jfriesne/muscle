...
public final class Message implements Flattenable
{
   ...
   /** Copy Constructor.
    *  @param copyMe The Message to make us a (wholly independant) copy of.
     */
   ...
   {
      return (_fieldTable != null) ? _fieldTable.keySet().iterator() : _empty.keySet().iterator();
   }
   ...
   public String toString()
   {
      ...
      ret.append("Message:  what='").append(whatString(what)).append("' (").append(what).append("), countFields=")
         .append(countFields()).append(", flattenedSize=").append(flattenedSize()).append('\n');
      Iterator iterator = fieldNames();
      while(iterator.hasNext())
      {
         String fieldName = (String) iterator.next();
         ret.append("   ").append(fieldName).append(": ").append(_fieldTable.get(fieldName)).append('\n');
      }
      return ret.toString();
   }
   ...
   public void flatten(ByteBuffer out) throws IOException 
   {
      ...
      while(e.hasNext())
      {
         ...
         int fieldValuePosition = out.position();
         out.position(fieldValuePosition+4);
         field.flatten(out);
         out.putInt(fieldValuePosition, out.position()-fieldValuePosition-4);
      }
   }
    ...
    *  @param vals Array of boolean values to assign to the field.  Note that the array is not copied; rather the passed-in array becomes part of the Message.
    */
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of byte values to assign to the field.  Note that the array is not copied; rather the passed-in array becomes part of the Message.
    */
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of short values to assign to the field.  Note that the array is not copied; rather the passed-in array becomes part of the Message.
    */
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of int values to assign to the field.  Note that the array is not copied; rather the passed-in array becomes part of the Message.
    */
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of long values to assign to the field.  Note that the array is not copied; rather the passed-in array becomes part of the Message.
    */
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of float values to assign to the field.  Note that the array is not copied; rather the passed-in array becomes part of the Message.
    */
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of double values to assign to the field.  Note that the array is not copied; rather the passed-in array becomes part of the Message.
    */
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of String values to assign to the field.  Note that the array is not copied; rather the passed-in array becomes part of the Message.
    */
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of Message objects to assign to the field.  Note that the neither the array nor the
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of Point objects to assign to the field.  Note that neither the array nor the 
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of Rect objects to assign to the field.  Note that neither the array nor the
    ...
    *  @param name Name of the field to set vlaues.
    *  @param vals Array of Flattenable objects to assign to the field.  The objects are all flattened and
   ...
   private final class MessageField implements Flattenable
   {
         ...
         switch(typeCode())
         {
            ...
            case B_MESSAGE_TYPE:
            {
               ...
               for (int i=0; i<_numItems; i++)
               {
                  ...
                  out.position(position+4);
                  array[i].flatten(out);
                  out.putInt(position, out.position()-position-4);
               }
            }
            break;
      ...
      public String toString()
      {
         ...
         ret.append(whatString(_type)).append("', ").append(_numItems).append(" items: ");
         ...
         switch(_type)
         {
            ...
            case B_MESSAGE_TYPE:
            {
               ...
               ret.append('[').append(whatString(array[i].what)).append(", ").append(array[i].countFields()).append(" fields] ");
            }
            break;
            ...
            {
               String [] array = (String[]) _payload;
               for (int i=0; i<pitems; i++) ret.append('[').append(array[i]).append("] ");
            }
            break;
            ...
            {
               byte [][] array = (byte[][]) _payload;
               for (int i=0; i<pitems; i++) ret.append('[').append(array[i].length).append(" bytes] ");
            }
            break;
         }
         return ret.toString();
   ...
   private static Map _empty; // = new Hashtable(0);  // had to change this to be done on-demand in the ctor, as IE was throwing fits :^(
}
